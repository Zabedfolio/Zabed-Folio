export const resumeProject = [
    ...
    },
    {
        ...
        features: [
            "Browse and filter travel packages by category and price, view destination details, and book trips with selected dates.",
            "Secure login with email/password and Google OAuth via Better Auth, with session persistence and protected routes.",
            "View and cancel bookings from a personal dashboard with data stored securely in MongoDB Atlas.",
            "Manage travel destinations (add, edit, delete) through a secured admin flow using JWKS JWT verification."
        ]
    }
];